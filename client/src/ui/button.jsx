 ...
 * - Handles 'asChild' pattern if needed (though simplified here for standard usage).
 * - Fully accessible via standard HTML button attributes.
 * * @dependencies
 * - class-variance-authority: For managing style variants.
 ...
 * @param {'default'|'destructive'|'outline'|'secondary'|'ghost'|'link'} [props.variant] - Visual style
